...
public class Controller {
  ...
  public void deleteContact() {
    ...
    alert.setContentText(
        new StringBuilder().append("Are you sure you want to remove the selected contact: ")
            .append(selectedContact.getFirstName()).append(' ')
            .append(selectedContact.getLastName()).toString());
